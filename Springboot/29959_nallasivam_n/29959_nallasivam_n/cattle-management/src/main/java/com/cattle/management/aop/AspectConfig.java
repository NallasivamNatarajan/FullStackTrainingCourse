package com.cattle.management.aop;
...
public class AspectConfig 
{
	...
	@Before(value = "execution(* com.htc.cattle.management.service.*.*(..))")
	...
	@After(value = "execution(* com.htc.cattle.management.service.*.*(..))")
	...
	@AfterReturning(value = "execution(* com.htc.cattle.management.service.*.*(..))", returning="retVal")
	public void logStatementAfterReturing(JoinPoint joinPoint,Object retVal)
	{
		log.info("After Returning {} "+ retVal.toString() );
	}
	
	@Around(value = "execution(* com.htc.cattle.management.service.*.*(..))")
