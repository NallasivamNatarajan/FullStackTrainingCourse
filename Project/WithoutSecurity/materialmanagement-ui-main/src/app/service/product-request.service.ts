...
export class ProductRequestService {
  ...
  prodReqUrl!:'http://localhost:8081/';
  ...
  private placeOrderUrl='/my-orders/'
  private placeOrderUrl2='/place-order';
  ...
  getDropDownValues():Observable<IDropDownValues>{
    return this.httpClient.get<IDropDownValues>('http://localhost:8081/material-management/placeOrder/getAllDropdownList');
  }

  placeOrder(userId:number,products : IProduct[]){
   // return this.httpClient.post<IProduct[]> ('http://localhost:8081/material-management/my-orders/1/place-order',products);
